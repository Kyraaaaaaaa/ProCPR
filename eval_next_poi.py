...
def parse_config():
    ...
    parser.add_argument('--output_dir', type=str, default="../dataset/Gowalla/SanFrancisco-LosAngeles/models/base_models", help='')
    ...
    parser.add_argument("--city_B", type=str, default="SanFrancisco", choices=['Baltimore','Austin','SanFrancisco'])
...
def main(args):
    ...
    lines = jload(dataset_path / f"{args.city_A}_{args.city_B}" / f"{args.test_file}")
